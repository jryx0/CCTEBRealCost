...
namespace PresentationControls
{
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
            ...
            : base()
        {
            ...
            ContainerControl.Padding = _CheckBoxProperties.CheckBoxPadding;// new Padding(4, 0, 0, 14);
        ...
        {
            this.DropDownControl.Padding = CheckBoxProperties.CheckBoxPadding;
            foreach (CheckBoxComboBoxItem Item in CheckBoxItems)
    ...
    public class CheckBoxProperties
    {
        ...
        private Padding _CheckBoxPadding = new Padding(4, 0, 0, 14);
        #endregion
        ...
        public Padding CheckBoxPadding
        {
            ...
            set { _CheckBoxPadding = value; OnPropertyChanged(); }
        }
